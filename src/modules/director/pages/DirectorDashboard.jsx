...
import { fetchDashboard } from '../services/directorService.js';
      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8">
        <div className="mb-8 flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Bienvenido de vuelta Director!. Aquí están todas tus clases actuales.
          </p>
        </div>

        <ClassesGrid classes={classes} rol="director" />
      </div>
