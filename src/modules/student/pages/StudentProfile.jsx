                        ...
                        <div className="flex items-center space-x-4">
                            <div className="w-20 h-20 rounded-full overflow-hidden bg-gray-100">
                                {previewImage ? (
                                    ...
                                    <img src="/placeholder.svg?height=80&width=80" alt="Current" className="w-full h-full object-cover" />
                                )}
                            </div>
                            <label className="cursor-pointer px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50">
                                Cambiar foto
...
export default function StudentProfile() {
    const [userName, setUserName] = useState("Manolo Pérez")
                    ...
                    <div className="flex flex-col md:flex-row gap-10">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h2 className="text-xl font-medium">Nota media 7/10</h2>
                                </div>

                                <div>
                                    <h3 className="text-lg font-medium">Últimos exámenes</h3>
                                    <ul className="mt-3 space-y-2 text-gray-700">
                                        {exams.map((exam, index) => (
                                            <li key={index} className="pl-2 border-l-2 border-purple-300">
                                                Examen 1 {exam.score}/10 {exam.name}
                                            </li>
                                        ))}
                                    </ul>
                                </div>
